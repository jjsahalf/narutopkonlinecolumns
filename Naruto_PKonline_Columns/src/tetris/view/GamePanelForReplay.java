...
public class GamePanelForReplay extends JPanel implements ControllerListener {
    ...
    public void display(ShapeForReplay shape, GroundForReplay ground) {
        this.shape = shape;
        this.ground = ground;
        this.repaint();
    }
