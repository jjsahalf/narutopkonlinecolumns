...
//            int y_random=15;//new Random().nextInt(Global.HEIGHT);
            ...
            if (Global.COLUMNS_IS_CHANGENet) {
                //      sound_thunder.play();
                switch (Global.COLOR_COLUMNSNet) {
                    case 1:
                        thunder_v.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNS; i++) {
                            thunder_v.One_Draw(g, Global.X_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5), Global.Y_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), (int) (Global.CELL_SIZE * 2),
                                    (int) (Global.CELL_SIZE * 2));
                        }
                        //                 thunder_circle.Update(fpsMonitor.GetTimeElapse());
                        //                thunder_circle.One_Draw(g,Global.CELL_SIZE,Global.CELL_SIZE,Global.CELL_SIZE*5,Global.CELL_SIZE*5);
                    ...
                    case 2:
                        wood_v.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNSNet; i++) {
                            wood_v.One_Draw(g, Global.X_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5), Global.Y_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), (int) (Global.CELL_SIZE * 2),
                                    (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 3:
                        water_v.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNSNet; i++) {
                            water_v.One_Draw(g, Global.X_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5), Global.Y_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), (int) (Global.CELL_SIZE * 2),
                                    (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 4:
                        fire_v.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNSNet; i++) {
                            fire_v.One_Draw(g, Global.X_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5), Global.Y_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), (int) (Global.CELL_SIZE * 2),
                                    (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 5:
                        earth_v.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNSNet; i++) {
                            earth_v.One_Draw(g, Global.X_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5), Global.Y_COLUMNSNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), (int) (Global.CELL_SIZE * 2),
                                    (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                }
            ...
            if (Global.BAR_IS_CHANGENet) {
                switch (Global.COLOR_BARNet) {
                    case 1:
                        thunder_h.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.HEIGHT_COLUMNSNet; i++) {
                            thunder_h.One_Draw(g, Global.X_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), Global.Y_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5),
                                    (int) (Global.CELL_SIZE * 2), (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 2:
                        wood_h.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.WIDTH_BARNet; i++) {
                            wood_h.One_Draw(g, Global.X_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), Global.Y_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5),
                                    (int) (Global.CELL_SIZE * 2), (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 3:
                        water_h.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.WIDTH_BARNet; i++) {
                            water_h.One_Draw(g, Global.X_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), Global.Y_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5),
                                    (int) (Global.CELL_SIZE * 2), (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 4:
                        fire_h.Update(fpsMonitor.GetTimeElapse());
                        for (int i = 0; i < Global.WIDTH_BARNet; i++) {
                            fire_h.One_Draw(g, Global.X_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * (0.5 - i)), Global.Y_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.5),
                                    (int) (Global.CELL_SIZE * 2), (int) (Global.CELL_SIZE * 2));
                        }
                        break;
                    case 5:
                        earth_h.Update(fpsMonitor.GetTimeElapse());
                        earth_h.One_Draw(g, Global.X_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.25 * Global.MIN), Global.Y_BARNet * Global.CELL_SIZE - (int) (Global.CELL_SIZE * 0.25),
                                (int) (Global.WIDTH_BARNet * Global.CELL_SIZE * 1.5), (int) (Global.CELL_SIZE * 1.5));
                        break;
                }
            }
            if (!Global.BAR_IS_CHANGENet) {
            ...
            if (Global.L2R_IS_CHANGENet) {
                switch (Global.COLOR_L2RNet) {
                    case 1:
                        thunder_l2r.Update(fpsMonitor.GetTimeElapse());
                        thunder_l2r.One_Draw(g, Global.X_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25), Global.Y_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 2:
                        wood_l2r.Update(fpsMonitor.GetTimeElapse());
                        wood_l2r.One_Draw(g, Global.X_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25), Global.Y_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 3:
                        water_l2r.Update(fpsMonitor.GetTimeElapse());
                        water_l2r.One_Draw(g, Global.X_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25), Global.Y_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 4:
                        fire_l2r.Update(fpsMonitor.GetTimeElapse());
                        fire_l2r.One_Draw(g, Global.X_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25), Global.Y_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 5:
                        earth_l2r.Update(fpsMonitor.GetTimeElapse());
                        earth_l2r.One_Draw(g, Global.X_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25), Global.Y_L2RNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
            ...
            if (Global.R2L_IS_CHANGENet) {
                switch (Global.COLOR_R2LNet) {
                    case 1:
                        thunder_r2l.Update(fpsMonitor.GetTimeElapse());
                        thunder_r2l.One_Draw(g, Global.X_R2LNet - (int) (Global.CELL_SIZE * Global.MIN), Global.Y_R2LNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 2:
                        wood_r2l.Update(fpsMonitor.GetTimeElapse());
                        wood_r2l.One_Draw(g, Global.X_R2LNet - (int) (Global.CELL_SIZE * Global.MIN), Global.Y_R2LNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 3:
                        water_r2l.Update(fpsMonitor.GetTimeElapse());
                        water_r2l.One_Draw(g, Global.X_R2LNet - (int) (Global.CELL_SIZE * Global.MIN), Global.Y_R2LNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 4:
                        fire_r2l.Update(fpsMonitor.GetTimeElapse());
                        fire_r2l.One_Draw(g, Global.X_R2LNet - (int) (Global.CELL_SIZE * Global.MIN), Global.Y_R2LNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                    case 5:
                        earth_r2l.Update(fpsMonitor.GetTimeElapse());
                        earth_r2l.One_Draw(g, Global.X_R2LNet - (int) (Global.CELL_SIZE * Global.MIN), Global.Y_R2LNet - (int) (Global.CELL_SIZE * Global.MIN * 0.25),
                                (int) (Global.MIN * Global.CELL_SIZE * 1.5), (int) (Global.MIN * Global.CELL_SIZE * 1.5));
                        break;
                }
            ...
            Global.COUNTERNet++;
            if (Global.COUNTERNet % Global.FREQUENCY == 0) {
                x_random = new Random().nextInt(Global.WIDTH - 2);
                y_random = new Random().nextInt(Global.HEIGHT);
                for (int columns = x_random; columns < x_random + 3; columns++) {
                    if(ground != null)
            ...
            if (Global.COUNTERNet % Global.FREQUENCY == 12) {
                for (int columns = x_random; columns < x_random + 3; columns++) {
                    if(ground != null){
                        ground.isCircleExist[y_random][columns] = true;
                    }
            ...
            if (Global.COUNTERNet % Global.FREQUENCY < 20 && Global.COUNTERNet % Global.FREQUENCY > 0) {
                for (int columns = x_random; columns < x_random + 3; columns++) {
