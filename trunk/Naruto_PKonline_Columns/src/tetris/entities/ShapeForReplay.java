...
public class ShapeForReplay {
    ...
    public void pause(){
        ...
        if(isPause){
            ...
            synchronized(ShapeForReplay.this){
                thread.resume();
            }
        }
    }
	...
	private class ShapeDriver implements Runnable{
		...
		public void run() {
			while(listener.isShapeMoveDownable(ShapeForReplay.this)){
                ...
                moveDown();
                listener.shapeMoveDown(ShapeForReplay.this);

            }
		}
	}

	public ShapeForReplay() {
		new Thread(new ShapeDriver()).start();
        init();
	}

    public ShapeForReplay(ShapeListener listener) {
